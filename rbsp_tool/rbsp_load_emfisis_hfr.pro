...
;    2. Added 'no_gyro' option, April 2015 
;
;
;--------------------------------------------------------------------
...
;---------------------------------------------------
pro rbsp_load_emfisis_hfr, datatype=datatype, probes=probes, level=level, no_gyro=no_gyro
...
for i=0, n_elements(probes)-1 do begin 
  ...
  if not keyword_set(no_gyro) then begin 
