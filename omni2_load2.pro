...
;   varformat= (Optional)variables of ISTP SW
;Example:
;   omni2_load2
;   omni2_load2,varformat='KP'
;Notes:
...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/idl_socware/tags/tdas_5_11/external/developers/solarwind/omni2_load.pro $
;-
pro omni2_load2,type,files=files,trange=trange,verbose=verbose,downloadonly=downloadonly, $
...
pathformat1 = 'omni/omni_cdaweb/hourly/YYYY/omni2_h0_mrg1hr_YYYY0101_v0?.cdf'
pathformat2 = 'omni/omni_cdaweb/hourly/YYYY/omni2_h0_mrg1hr_YYYY0701_v0?.cdf'
...
IF keyword_set(varformat) EQ 0 THEN BEGIN
varformat='Pressure ABS_B F THETA_AV PHI_AV BX_GSE BY_GSE BZ GSE BY_GSM BZ_GSM SIGMA-ABS_B SIGMA-B SIGMA-Bx SIGMA-By SIGMA-Bz T N V PHI-V THETA-V Ratio Pressure SIGMA-T SIGMA-N SIGMA-V SIGMA-PHI-V SIGMA-THETA-V SIGMA-ratio E Beta Mach_num KP R DST AE PR-FLX_1 PR-FLX_2 PR-FLX_4 PR_FLX_10 PR-FLX_30 PR-FLX_60 MFLX AP_INDEX F10_INDEX PC_N_INDEX AL_INDEX AU_INDEX'
ENDIF
